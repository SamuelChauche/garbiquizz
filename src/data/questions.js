...
export const QUESTIONS = [
  ...
  },
  {
    ...
    question: "Comment appelle-t-on le plan immergé à l'arrière du bateau qui sert à le diriger ?",
  ...
  },
  {
    ...
    question: "Sur un petit voilier comme le Garbi, comment se nomme le levier qu'on tient en main pour actionner le gouvernail ?",
  ...
  // ─── PALIER 4 — Saisie texte (expert) ───────────────────────────
  {
    ...
    question: "La pièce courbe qui assure la jonction entre l'étrave et la quille s'appelle le _____.",
    answer: 'brion',
